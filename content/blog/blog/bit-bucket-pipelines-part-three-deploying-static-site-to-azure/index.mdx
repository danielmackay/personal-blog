...
We need to create a frontend application.  We could use any frontend framework such as Angular, Vue, or even plain HTML.  My personal preference is react.
...
### Azure Storage
Before we can deploy, we need somewhere to.  For the brevity of this blog post, I'll assume you already have an Azure account and know how to create a storage service.
